          ...
          <div key={`mobile-layout-${Date.now()}`} className="mobile-stack flex flex-col md:grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="w-full md:w-auto space-y-6 order-1">
              ...
              <div className="flex justify-center md:justify-start gap-4">
                ...
                <a href="https://www.facebook.com/people/Clash-Casino-Games/61579792407380/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300 cursor-pointer shadow-md hover:shadow-lg">
                  <svg className="w-6 h-6 text-black" fill="currentColor" viewBox="0 0 24 24">
