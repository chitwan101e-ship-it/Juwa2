        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="https://www.facebook.com/people/Clash-Casino-Games/61579792407380/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-semibold">
            ...
            <div className="overflow-hidden scrollbar-hide" style={{scrollbarWidth: 'none', msOverflowStyle: 'none'}}>
              ...
              >
                      ...
                      <div className="w-full md:w-1/2 h-48 md:h-auto bg-black flex flex-col items-center justify-center relative overflow-hidden">
                        {index === 1 ? (
                          ...
                          <video
                            ...
                            playsInline
                          >
                            <source src={`./videos/spinwheel.mp4?v=${Date.now()}`} type="video/mp4" />
                          </video>
                        ) : (
                ...
                <div>
                        ...
                        <button className="bg-white hover:bg-gray-100 text-black text-base font-bold uppercase tracking-wide py-3 px-6 rounded-xl transition-colors duration-300 w-fit">
                          JOIN THE FUN
                        </button>
                </div>
              </div>
          ...
          <div key={`mobile-layout-${Date.now()}`} className="mobile-stack flex flex-col md:grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="w-full md:w-auto space-y-6 order-1">
              ...
              <div className="flex justify-center md:justify-start">
                <div className="bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-2xl p-6 shadow-xl max-w-sm w-full">
                  <div className="text-center">
                    ...
                    <a href="https://www.facebook.com/people/Clash-Casino-Games/61579792407380/" target="_blank" rel="noopener noreferrer" className="w-full bg-white hover:bg-gray-50 text-black font-bold uppercase tracking-wide px-6 py-3 rounded-xl transition-all duration-300 border border-gray-300 text-sm shadow-md hover:shadow-lg block text-center">
                      JOIN OUR COMMUNITY
                    </a>
                  </div>
                </div>
              ...
              <div className="flex justify-center md:justify-start gap-4">
                <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300 cursor-pointer shadow-md hover:shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden">
            ...
            <video
              ...
              playsInline
            >
              <source src={`./videos/footer3.mp4?v=${Date.now()}`} type="video/mp4" />
            </video>
