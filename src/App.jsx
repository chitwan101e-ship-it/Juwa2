      ...
      <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-zinc-950/70 border-b border-zinc-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="https://www.facebook.com/people/Juwa-Jackpot-quest/61584448090525/?mibextid=wwXIfr&rdid=LxxlfG7JeVDYrcCU&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1G81hrse4X%2F%3Fmibextid%3DwwXIfr" target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-semibold text-sm">Sign up</a>
          </div>
        </div>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="https://m.juwa2.xin/v1/user/register?code=1AZu1F" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-semibold">
                Play Directly <ChevronRight className="w-4 h-4" />
              </a>
              <a href="https://www.facebook.com/people/Juwa-Jackpot-quest/61584448090525/?mibextid=wwXIfr&rdid=LxxlfG7JeVDYrcCU&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1G81hrse4X%2F%3Fmibextid%3DwwXIfr" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl border border-zinc-800 hover:bg-zinc-900">
                Play with Agent
              </a>
            </div>
          </motion.div>
            ...
            <div className="overflow-hidden scrollbar-hide" style={{scrollbarWidth: 'none', msOverflowStyle: 'none'}}>
              ...
              >
                ...
                <div>
                        ...
                        <a 
                          href="https://www.facebook.com/people/Juwa-Jackpot-quest/61584448090525/?mibextid=wwXIfr&rdid=LxxlfG7JeVDYrcCU&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1G81hrse4X%2F%3Fmibextid%3DwwXIfr" 
                          target="_blank" 
                          rel="noopener noreferrer"
                          className="bg-white hover:bg-gray-100 text-black text-base font-bold uppercase tracking-wide py-3 px-6 rounded-xl transition-colors duration-300 w-fit inline-block text-center"
                        >
                          JOIN THE FUN
                        </a>
                </div>
          ...
          <div key={`mobile-layout-${Date.now()}`} className="mobile-stack flex flex-col md:grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="w-full md:w-auto space-y-6 order-1">
              ...
              <div className="flex justify-center md:justify-start">
                <div className="bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-2xl p-6 shadow-xl max-w-sm w-full">
                  <div className="text-center">
                    ...
                    <a href="https://www.facebook.com/people/Juwa-Jackpot-quest/61584448090525/?mibextid=wwXIfr&rdid=LxxlfG7JeVDYrcCU&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1G81hrse4X%2F%3Fmibextid%3DwwXIfr" target="_blank" rel="noopener noreferrer" className="w-full bg-white hover:bg-gray-50 text-black font-bold uppercase tracking-wide px-6 py-3 rounded-xl transition-all duration-300 border border-gray-300 text-sm shadow-md hover:shadow-lg block text-center">
                      JOIN OUR COMMUNITY
                    </a>
                  </div>
                </div>
              ...
              <div className="flex justify-center md:justify-start gap-4">
                ...
                <a href="https://www.facebook.com/people/Juwa-Jackpot-quest/61584448090525/?mibextid=wwXIfr&rdid=LxxlfG7JeVDYrcCU&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1G81hrse4X%2F%3Fmibextid%3DwwXIfr" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300 cursor-pointer shadow-md hover:shadow-lg">
                  <svg className="w-6 h-6 text-black" fill="currentColor" viewBox="0 0 24 24">
